...
import chapter04.control.EdgeCheckControl;
 ...
 * @author Rickard
 */
public class TestEdgeDetection extends SimpleApplication {
    ...
    public static void main(String[] args) {
        TestEdgeDetection app = new TestEdgeDetection();
        app.start();
    }
    ...
    public void simpleInitApp() {
        ...
        EdgeCheckControl edgeControl = new EdgeCheckControl();
        playerNode.addControl(edgeControl);
        edgeControl.setWorld(rootNode.getChild("Floor"));
    }
