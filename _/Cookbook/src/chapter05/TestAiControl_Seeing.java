...
public class TestAiControl_Seeing extends SimpleApplication{
    ...
    public static void main(String[] args) {
        TestAiControl_Seeing app = new TestAiControl_Seeing();
        app.start();
    }
    ...
    public void simpleInitApp() {
        ...
        aiCharacter.addControl(new AIControl_Seeing());
...
//        characterNode.getControl(AIControl.class).setAction(AIControl.Action.Follow);
        ...
        targets.add(camNode);
        aiCharacter.getControl(AIControl_Seeing.class).setTargetList(targets);
    }
