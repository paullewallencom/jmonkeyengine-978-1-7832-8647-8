...
import chapter02.state.CharacterInputAppState_Firing_NonInstant;
 ...
 * @author Rickard
 */
public class CharacterInputTest_Firing_NonInstant extends SimpleApplication {
    ...
    public static void main(String[] args) {
        CharacterInputTest_Firing_NonInstant app = new CharacterInputTest_Firing_NonInstant();
        app.start();
    }
    ...
    public void simpleInitApp() {
        ...
        CharacterInputAppState_Firing_NonInstant appState = new CharacterInputAppState_Firing_NonInstant();
