 ...
 * @author Rickard
 */
public class CharacterInputTest extends SimpleApplication {
    ...
    public static void main(String[] args) {
        CharacterInputTest app = new CharacterInputTest();
        app.start();
    }
    ...
    public void simpleInitApp() {
        ...
        GameCharacterControl charControl = new GameCharacterControl(1.1f, 2.5f, 8f);
