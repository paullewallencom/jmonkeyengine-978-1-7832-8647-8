 ...
 * @author Rickard
 */
public class AdvAnimationManagerIK extends AbstractControl implements AnimEventListener, ActionListener, AnalogListener{
    ...
    public AdvAnimationManagerIK(){
        
    }
    
    public AdvAnimationManagerIK(String animationNameFile){
        animationNames = new Properties();
        try {
            animationNames.load(getClass().getClassLoader().getResourceAsStream(animationNameFile));
        } catch (IOException ex) {
            Logger.getLogger(AdvAnimationManagerIK.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                setAnimation(Animation.JumpEnd);
    ...
    public Control cloneForSpatial(Spatial spatial) {
        AdvAnimationManagerIK control = new AdvAnimationManagerIK();
    ...
    public void onAnimChange(AnimControl control, AnimChannel channel, String animName) {
        if(animName.equals("Idle")){
            spatial.getControl(ChaseCamCharacter.class).setEnabled(false);
            spatial.getControl(KinematicRagdollControl.class).setEnabled(true);
        } else {
            spatial.getControl(ChaseCamCharacter.class).setEnabled(true);
            spatial.getControl(KinematicRagdollControl.class).setEnabled(false);
        }
    }
