 ...
 * @author Rickard
 */
public class DualAnimationManagerControl extends AbstractControl implements AnimEventListener{
    ...
    public Control cloneForSpatial(Spatial spatial) {
        DualAnimationManagerControl control = new DualAnimationManagerControl();
